...
public class StudentController {
	...
	public ResponseEntity<Student> getStudentforId(@PathVariable("studentId") int studentId)
	...
	@PutMapping(value = "/student/edit/{studentid}", consumes = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<Student> updateStudent(@PathVariable("studentid") int studentid, @RequestBody Student s)
			throws StudentException, EntityNotFoundException, StudentNotFoundException,
			RegistrationRequestNotApprovedException {
	...
	public ResponseEntity<String> deleteStudentById(@PathVariable("studentid") int studentid) {
		boolean s = studentService.deleteStudentById(studentid);
		if (s == false) {
